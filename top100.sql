...
--- Revisar los archivos peliculas.csv y reparto.csv para crear las tablas correspondientes, determinando la  relación   entre ambas tablas.
    ...
    -- Cargar ambos archivos a su tabla correspondiente
        \copy tabpeliculas FROM '/home/david/Escritorio/db/desafios/desafio top 100/peliculas.csv' csv header;
        \copy reparto FROM '/home/david/Escritorio/db/desafios/desafio top 100/reparto.csv' csv;
